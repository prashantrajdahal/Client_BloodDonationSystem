...
Geocode.setApiKey("AIzaSyDY_pqTgOGHkm18lGCQO_WHN6yN4HyFz4o");
Geocode.enableDebug();
  ...
  render() {
    ...
    return (
      <div style={{ padding: "1rem", margin: "0 auto", maxWidth: 1000 }}>
        <EDDonar lat={this.state.markerPosition.lat} lng={this.state.markerPosition.lng} />
        
        <AsyncMap
          googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDY_pqTgOGHkm18lGCQO_WHN6yN4HyFz4o&libraries=places"
          loadingElement={<div style={{ height: `100%` }} />}
